...
export function Chat({ id, initialMessages, className }: ChatProps) {
  ...
  const { messages, append, reload, stop, isLoading, input, setInput } = useChat({
    api: '/api/chat/anthropic-bedrock',
    initialMessages,
    id,
    body: {
      id,
    ...
    onFinish() {
      // we would normally use this to update the URL & save the chat to the database
    },
  });
  return (
    <>
        ...
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              ...
              open source community can test the app. The token will be saved to your
